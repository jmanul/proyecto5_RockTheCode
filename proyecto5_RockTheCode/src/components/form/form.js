...
export const createForm = () => {
     ...
     addLetterContainer.innerHTML = `<form class="add-letter">Introduce una letra <div class="flex-container"><input type="text" name="letter" id="letter-input" required minlength="1" maxlength="1"><button type="submit" id ="letter-send"><img src="./assets/arrow.svg" alt="send"></button></div></form>`;
