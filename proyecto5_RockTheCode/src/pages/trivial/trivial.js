...
export const createTrivial = (button) => {
     ...
     containerAnswers.innerHTML = `<form class="answer flex-container"> <input type="text" placeholder="respuesta" name="answer" id="answer"><button type="submit" id ="answer-send"><img src="./assets/arrow.svg" alt="send"></button></form>`;
